...
from psched.psched import psched

class t_psched(Testable):
    '''|
    ...
    def __init__(self):
        ...
        self.ref_data = { "tx_port":(self.ref_tx_port, self.res_tx_port),\
                          "sequence":(self.ref_sequence, self.res_sequence),\
    ...
    def use_data_from_files(self):
        ...
        self.res_sequence.append({"file" : self.test_path + "/vectors/my_sequence.tvr"})
        self.ref_sequence.append({"file" : self.test_path + "/vectors/sequence.tvr"})
