...
from src.B_beh import *
from src.B_rtl import *
...
class B(Convertible):
    ...
    def __init__(self, IMPL={}):
        ...
        self.interfaces = lambda fdump : [
            SimpleBus(bus_type=SBUS, name="sbus", reg_file=True, filedump=fdump)
        ]
    ...
    def top(self,
            rst, clk,
            sbus_wa_wd_ready,sbus_wa_wd_valid,sbus_wa_wd_addr,sbus_wa_wd_data,
            sbus_raddr_ready,sbus_raddr_valid,sbus_raddr_data,
            sbus_rdata_ready,sbus_rdata_valid,sbus_rdata_data):
        '''|
