...
from src.SimpleBusRegFile_beh import *
from src.SimpleBusRegFile_rtl import *

class SimpleBusRegFile(Convertible):
    '''|
    | The design class
    |________'''
    def __init__(self, IMPL={}):
        ...
        self.interfaces = lambda fdump : [
            SimpleBus(bus_type=SBUS, name="simple_bus", reg_file=True, filedump=fdump)
        ]
        ...
        self.funcdict = {
            'beh': SimpleBusRegFile_beh,
            'rtl': SimpleBusRegFile_rtl,
            'vrg': None
        }
