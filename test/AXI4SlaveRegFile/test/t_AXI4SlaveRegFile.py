...
from AXI4SlaveRegFile.AXI4SlaveRegFile import AXI4SlaveRegFile

class t_AXI4SlaveRegFile(Testable):
    '''|
    ...
    def run_it(self, checkfiles=False):
        self.check_config("AXI4SlaveRegFile")

        AXI4SlaveRegFile_dut = AXI4SlaveRegFile(IMPL=self.models)
        AXI4SlaveRegFile_dut.Simulate(tb_config=self.tb_config, tst_data=self.tst_data, verbose=self.verbose)
        AXI4SlaveRegFile_dut.clean()
