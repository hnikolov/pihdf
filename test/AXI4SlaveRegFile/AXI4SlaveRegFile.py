...
from src.AXI4SlaveRegFile_beh import *
from src.AXI4SlaveRegFile_rtl import *

class AXI4SlaveRegFile(Convertible):
    '''|
    | The design class
    |________'''
    def __init__(self, IMPL={}):
        ...
        self.funcdict = {
            'beh': AXI4SlaveRegFile_beh,
            'rtl': AXI4SlaveRegFile_rtl,
            'vrg': None
        }
