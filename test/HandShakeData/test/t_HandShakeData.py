...
class t_HandShakeData(Testable):
    ...
    def use_data_from_files(self):
        ...
        self.stim_rx_push.append({"file" : self.test_path + "/vectors/rx_push.tvr"})
        ...
        self.res_ipg_rx_width.append({"file" : self.test_path + "/vectors/my_ipg_rx_width.tvr"})
        self.ref_ipg_rx_width.append({"file" : self.test_path + "/vectors/ipg_rx_width.tvr"})
    ...
    def run_it(self, checkfiles=False):
        self.check_config("HandShakeData")

        HandShakeData_dut = HandShakeData(IMPL=self.models)
        HandShakeData_dut.Simulate(tb_config=self.tb_config, tst_data=self.tst_data, verbose=self.verbose)
        HandShakeData_dut.clean()
