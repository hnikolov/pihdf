...
from src.HandShakeData_beh import *
from src.HandShakeData_rtl import *

class HandShakeData(Convertible):
    '''|
    | The design class
    |________'''
    def __init__(self, IMPL={}):
        ...
        self.funcdict = {
            'beh': HandShakeData_beh,
            'rtl': HandShakeData_rtl,
            'vrg': None
        }
