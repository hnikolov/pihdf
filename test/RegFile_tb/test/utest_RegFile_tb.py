...
from t_RegFile_tb import t_RegFile_tb

class Test_RegFile_tb(t_RegFile_tb):
    '''|
    | The main class for unit-testing. Add your tests here.
    |________'''
    def __init__(self):
        # call base class constructor
        t_RegFile_tb.__init__(self)

    # Automatically executed BEFORE every TestCase
    def setUp(self):
        t_RegFile_tb.setUp(self)
    ...
    def test_001(self):
        ...
        for j,i in enumerate([0, 6, 11, 16, 19, 24]):
